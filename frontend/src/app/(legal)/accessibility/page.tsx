export default function Page() {
  return (
    <main className="mx-auto flex max-w-3xl flex-col gap-6 px-6 py-16">
      <div>
        <h1 className="text-3xl font-semibold text-foreground">Accessibility</h1>
      ...
      <div className="flex flex-col gap-5 text-sm leading-relaxed text-foreground">
        ...
        <section>
          <h2 className="mb-1 font-semibold">What we do</h2>
        ...
        <section>
          <h2 className="mb-1 font-semibold">Known limitations</h2>
          <p>
