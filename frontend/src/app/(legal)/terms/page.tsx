  ...
  return (
    <main className="mx-auto flex max-w-3xl flex-col gap-6 px-6 py-16">
      ...
      <div className="flex flex-col gap-5 text-sm leading-relaxed text-foreground">
        <section>
          <h2 className="mb-1 font-bold">1. Acceptance of terms</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold">2. What Brew Scout is</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold">3. Your account</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold">4. Reviews and content you submit</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold">5. Acceptable use</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold">6. Third-party services</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold">7. Changes and termination</h2>
          <p>
        ...
        <section>
          <h2 className="mb-1 font-bold">8. Contact</h2>
